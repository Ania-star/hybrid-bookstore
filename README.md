...
The current implementation uses a bookstore as an example, where users can browse books, place orders, and leave reviews. Admins can see stats and monitor customer locations.
...
│   ├── sqlite.png                      # Relational database ER diagram
...
| **Get Review Statistics** | MongoDB | Aggregation Pipeline | System / Backend | Calculates how many reviews each book has and the average rating per book. |
